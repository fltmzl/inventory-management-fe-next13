...
import {
  formatArrayOfItemToString,
  formatArrayOfItemToStringWithLotNumber,
} from "@/utils/formatArray";
  ...
  const handlerExportPdf = async () => {
    ...
    const mappedTransactions = transactions.map((transaction) => {
      return [
        ...
        formatArrayOfItemToStringWithLotNumber(transaction.barang),
    ...
    autoTable(doc, {
      ...
      head: [["ID Transaksi", "Pelanggan", "Barang", "Harga Total"]],
